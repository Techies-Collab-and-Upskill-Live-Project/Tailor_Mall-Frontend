...
const JobApplicationDetail = ({ singleJob }) => {
  return (
      ...
      <div className="flex flex-col gap-4 self-stretch w-full">
        ...
        <div className="flex items-start content-start gap-16 md:gap-[72px] flex-wrap">
          ...
          <div className="flex items-center gap-2 ">
            <h5 className="text-[12px] leading-[14.4px] md:text-[14px]">
              Posted
            </h5>
            <h5 className="text-[12px] leading-[14.4px] md:text-[14px]">
              {singleJob.updatedAt}
      ...
      <div className="flex flex-col items-start gap-3 self-stretch">
        ...
        <div className="flex items-center gap-2 self-stretch">
          <img
            ...
            alt=""
          />
          <p className="text-[14px] leading-[16.8px]"></p>
        </div>
      </div>
    </div>
  );
