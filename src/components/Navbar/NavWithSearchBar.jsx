...
const NavWithSearchBar = () => {
  return (
    <div className="flex px-5 sm:px-12 lg:py-[17px] py-[12px] items-center justify-between border-b lg:gap-x-[150px]">
      <div className="flex flex-1 gap-x-[18px] lg:justify-between items-center">
        <i className="fa-solid fa-bars lg:hidden text-[18px]"></i>
        <img className="lg:w-[130px] w-[100px]" src={logo} alt="" />
      ...
      <div className="flex lg:w-[360px] justify-between items-center">
        ...
        <i className="fa-solid fa-magnifying-glass mr-[18px] flex lg:hidden text-[20px]"></i>
        <img
          src={profileImg}
          className="lg:w-[40px] w-[30px] rounded-full"
          alt=""
        />
      </div>
    </div>
