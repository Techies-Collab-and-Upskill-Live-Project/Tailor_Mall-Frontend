...
const VerifyMail = () => {
  ...
  return (
    <>
    <div className={`
      flex px-5 gap-7 flex-col absolute left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] ${resendMail ? "h-full w-full bg-[#000000] opacity-[40%] justify-center overflow-hidden -z-50" : "bg-white"}`}>
        ...
        <form>
          <div className="flex flex-row items-center justify-evenly">
            {otpValues.map((input, index) => (
              <input
                type="text"
                className="text-center outline-none border-none bg-[#E6f2f2] text-[#535353] text-xl font-medium w-10 h-10"
              />
            ))}
          </div>
        </form>
      ...
      <div className="">
        ...
        <div className="flex items-center justify-center gap-3 py-4">
          <p className="font-normal text-base leading-[22.4px] text-center text-[#535353]">
